...
(assert true)
; Global hypotheses
(assert (forall ((x_13 (P Int)) ) (=> (mem2 g_c1_3 x_13 g_fun1_1) (mem0 g_c0_2 x_13))))
; Local hypotheses
; Goal
(assert (not (forall ((x_14 (P Int))(x_15 Int) ) (=> (and (forall ((x_16 Int) ) (=> (= x_16 2) (mem2 x_16 x_14 g_rel1_0))) (= x_15 2)) (mem0 x_15 x_14)))))
(check-sat)
(exit)
