...
(assert true)
; Global hypotheses
(assert (and  (exists ( (x_20 Int) ) (mem2 g_c0_5 x_20 g_rr_2)) (forall ( (x_21 Int) ) (= (= x_21 g_c1_6) (exists ( (x_22 Int) ) (and  (= x_22 g_c0_5) (mem2 x_22 x_21 g_rr_2)))))))
; Local hypotheses
; Goal
(assert (not (and  (exists ( (x_24 Int) ) (forall ((x_25 Int) ) (=> (= x_25 10) (mem2 x_25 x_24 g_ss_3)))) (forall ( (x_26 Int) ) (= (= x_26 5) (exists ( (x_27 Int) ) (and  (= x_27 10) (mem2 x_27 x_26 g_ss_3))))))))
(check-sat)
(exit)
