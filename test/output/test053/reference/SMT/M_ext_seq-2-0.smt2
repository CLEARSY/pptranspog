...
(assert (<= 0 g_ii_2))
; Global hypotheses
(assert (or  (and (= 2 1) (= 4 5)) (and (= 2 2) (= 4 4)) (and (= 2 3) (= 4 1)) (and (= 2 4) (= 4 1)) (and (= 2 5) (= 4 2)) (and (= 2 6) (= 4 3)) (and (= 2 7) (= 4 8))))
(assert (forall ((x_29 Int)(x_30 Int) ) (=> (and (= x_29 1) (= x_30 6)) (mem2 x_29 x_30 g_empty_seq_0))))
; Local hypotheses
; Goal
(assert (not (mem2 g_ii_2 g_c0_3 g_ss_1)))
(check-sat)
(exit)
