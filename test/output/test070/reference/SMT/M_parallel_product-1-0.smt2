...
(declare-fun g_c1_8 () Int)
(declare-fun g_c2_7 () Int)
(declare-fun g_c3_9 () Real)
...
(assert true)
; Global hypotheses
(assert (and (forall ((x_21 Int)(x_22 Int) ) (=> (and (= x_21 10) (= x_22 5)) (mem2 x_21 x_22 g_ss_3))) (forall ((x_23 Int)(x_24 Int) ) (=> (and (= x_23 (- 2)) (= x_24 2)) (mem2 x_23 x_24 g_tt_4)))))
; Local hypotheses
; Goal
(assert (not (and (mem2 g_c0_6 g_c2_7 g_rr_2) (mem3 g_c1_8 g_c3_9 g_uu_5))))
(check-sat)
(exit)
