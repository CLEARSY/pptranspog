...
; Global hypotheses
(assert (forall ((x_82 (P Int)) ) (=> (forall ( (x_83 Int) ) (= (mem0 x_83 x_82) (exists ( (x_84 Int) ) (and  (mem0 x_84 g_S1_0) (= x_83 x_84))))) (> (isum x_82) 0))))
(assert (forall ((x_85 (P Int)) ) (=> (forall ( (x_86 Int) ) (= (mem0 x_86 x_85) (exists ( (x_87 Int) ) (and  (mem0 x_87 g_S2_1) (= x_86 x_87))))) (> (isum x_85) 1))))
(assert (forall ((x_88 (P Int)) ) (=> (forall ( (x_89 Int) ) (= (mem0 x_89 x_88) (exists ( (x_90 Int) ) (and  (mem0 x_90 g_S3_2) (= x_89 x_90))))) (> (isum x_88) 6))))
(assert (forall ((x_91 (P Int)) ) (=> (forall ( (x_92 Int) ) (= (mem0 x_92 x_91) (exists ( (x_93 Int) ) (and  (mem0 x_93 g_S1_0) (= x_92 x_93))))) (> (iprod x_91) 1))))
; Local hypotheses
; Goal
(assert (not (forall ((x_94 (P Int)) ) (=> (forall ( (x_95 Int) ) (= (mem0 x_95 x_94) (exists ( (x_96 Int) ) (and  (mem0 x_96 g_S2_1) (= x_95 x_96))))) (> (iprod x_94) 1)))))
(check-sat)
(exit)
