...
; Global hypotheses
(assert (forall ((x_70 (P Int)) ) (=> (forall ( (x_71 Int) ) (= (mem0 x_71 x_70) (exists ( (x_72 Int) ) (and  (mem0 x_72 g_S1_0) (= x_71 x_72))))) (> (isum x_70) 0))))
(assert (forall ((x_73 (P Int)) ) (=> (forall ( (x_74 Int) ) (= (mem0 x_74 x_73) (exists ( (x_75 Int) ) (and  (mem0 x_75 g_S2_1) (= x_74 x_75))))) (> (isum x_73) 1))))
(assert (forall ((x_76 (P Int)) ) (=> (forall ( (x_77 Int) ) (= (mem0 x_77 x_76) (exists ( (x_78 Int) ) (and  (mem0 x_78 g_S3_2) (= x_77 x_78))))) (> (isum x_76) 6))))
; Local hypotheses
; Goal
(assert (not (forall ((x_79 (P Int)) ) (=> (forall ( (x_80 Int) ) (= (mem0 x_80 x_79) (exists ( (x_81 Int) ) (and  (mem0 x_81 g_S1_0) (= x_80 x_81))))) (> (iprod x_79) 1)))))
(check-sat)
(exit)
