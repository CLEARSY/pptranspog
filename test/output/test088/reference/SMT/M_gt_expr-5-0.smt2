...
; Global hypotheses
(assert (forall ((x_97 (P Int)) ) (=> (forall ( (x_98 Int) ) (= (mem0 x_98 x_97) (exists ( (x_99 Int) ) (and  (mem0 x_99 g_S1_0) (= x_98 x_99))))) (> (isum x_97) 0))))
(assert (forall ((x_100 (P Int)) ) (=> (forall ( (x_101 Int) ) (= (mem0 x_101 x_100) (exists ( (x_102 Int) ) (and  (mem0 x_102 g_S2_1) (= x_101 x_102))))) (> (isum x_100) 1))))
(assert (forall ((x_103 (P Int)) ) (=> (forall ( (x_104 Int) ) (= (mem0 x_104 x_103) (exists ( (x_105 Int) ) (and  (mem0 x_105 g_S3_2) (= x_104 x_105))))) (> (isum x_103) 6))))
(assert (forall ((x_106 (P Int)) ) (=> (forall ( (x_107 Int) ) (= (mem0 x_107 x_106) (exists ( (x_108 Int) ) (and  (mem0 x_108 g_S1_0) (= x_107 x_108))))) (> (iprod x_106) 1))))
(assert (forall ((x_109 (P Int)) ) (=> (forall ( (x_110 Int) ) (= (mem0 x_110 x_109) (exists ( (x_111 Int) ) (and  (mem0 x_111 g_S2_1) (= x_110 x_111))))) (> (iprod x_109) 1))))
; Local hypotheses
; Goal
(assert (not (forall ((x_112 (P Int)) ) (=> (forall ( (x_113 Int) ) (= (mem0 x_113 x_112) (exists ( (x_114 Int) ) (and  (mem0 x_114 g_S3_2) (= x_113 x_114))))) (> (iprod x_112) 6)))))
(check-sat)
(exit)
