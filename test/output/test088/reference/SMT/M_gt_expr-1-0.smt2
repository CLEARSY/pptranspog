...
; Global hypotheses
(assert (forall ((x_55 (P Int)) ) (=> (forall ( (x_56 Int) ) (= (mem0 x_56 x_55) (exists ( (x_57 Int) ) (and  (mem0 x_57 g_S1_0) (= x_56 x_57))))) (> (isum x_55) 0))))
; Local hypotheses
; Goal
(assert (not (forall ((x_58 (P Int)) ) (=> (forall ( (x_59 Int) ) (= (mem0 x_59 x_58) (exists ( (x_60 Int) ) (and  (mem0 x_60 g_S2_1) (= x_59 x_60))))) (> (isum x_58) 1)))))
(check-sat)
(exit)
