...
(assert true)
; Global hypotheses
(assert (exists ( (x_172 (P (C Int Int))) ) (and  (forall ( (x_173 Int) (x_174 Int) ) (= (mem2 x_174 x_173 x_172) (mem2 x_174 x_173 g_s0_0))) (or  (mem2 g_ii_5 g_c0_6 x_172) (forall ((x_175 Int) ) (=> (forall ((x_176 Int) ) (=> (forall ( (x_177 Int) ) (= (exists ( (x_178 Int) ) (mem2 x_177 x_178 x_172)) (and (>= x_177 1) (<= x_177 x_176)))) (= x_175 (- g_ii_5 x_176)))) (mem2 x_175 g_c0_6 g_s1_1)))))))
(assert (exists ( (x_179 (P (C Int Int))) ) (and  (forall ( (x_180 Int) (x_181 Int) ) (= (mem2 x_181 x_180 x_179) (mem2 x_181 x_180 g_empty_seq_4))) (or  (mem2 g_ii_5 g_c0_6 x_179) (forall ((x_182 Int) ) (=> (forall ((x_183 Int) ) (=> (forall ( (x_184 Int) ) (= (exists ( (x_185 Int) ) (mem2 x_184 x_185 x_179)) (and (>= x_184 1) (<= x_184 x_183)))) (= x_182 (- g_ii_5 x_183)))) (mem2 x_182 g_c0_6 g_s0_0)))))))
(assert (exists ( (x_186 (P (C Int Int))) ) (and  (forall ( (x_187 Int) (x_188 Int) ) (= (mem2 x_188 x_187 x_186) (mem2 x_188 x_187 g_s0_0))) (or  (mem2 g_ii_5 g_c0_6 x_186) (forall ((x_189 Int) ) (=> (forall ((x_190 Int) ) (=> (forall ( (x_191 Int) ) (= (exists ( (x_192 Int) ) (mem2 x_191 x_192 x_186)) (and (>= x_191 1) (<= x_191 x_190)))) (= x_189 (- g_ii_5 x_190)))) (mem2 x_189 g_c0_6 g_empty_seq_4)))))))
(assert (exists ( (x_193 (P (C Int Int))) ) (and  (forall ( (x_194 Int) (x_195 Int) ) (= (mem2 x_195 x_194 x_193) (mem2 x_195 x_194 g_empty_seq_4))) (or  (mem2 g_ii_5 g_c0_6 x_193) (forall ((x_196 Int) ) (=> (forall ((x_197 Int) ) (=> (forall ( (x_198 Int) ) (= (exists ( (x_199 Int) ) (mem2 x_198 x_199 x_193)) (and (>= x_198 1) (<= x_198 x_197)))) (= x_196 (- g_ii_5 x_197)))) (mem2 x_196 g_c0_6 g_empty_seq_4)))))))
(assert (exists ( (x_200 (P (C Int Int))) ) (and  (forall ( (x_201 Int) (x_202 Int) ) (= (mem2 x_202 x_201 x_200) (mem2 x_202 x_201 g_s2_2))) (or  (forall ((x_203 Int)(x_204 Int) ) (=> (and (= x_203 5) (= x_204 5)) (mem2 x_203 x_204 x_200))) (forall ((x_205 Int)(x_206 Int) ) (=> (and (forall ((x_207 Int) ) (=> (forall ( (x_208 Int) ) (= (exists ( (x_209 Int) ) (mem2 x_208 x_209 x_200)) (and (>= x_208 1) (<= x_208 x_207)))) (= x_205 (- 5 x_207)))) (= x_206 5)) (mem2 x_205 x_206 g_s3_3)))))))
; Local hypotheses
; Goal
(assert (not (exists ( (x_210 (P (C Int Int))) ) (and  (forall ( (x_211 Int) (x_212 Int) ) (= (mem2 x_212 x_211 x_210) (mem2 x_212 x_211 g_s3_3))) (or  (forall ((x_213 Int)(x_214 Int) ) (=> (and (= x_213 5) (= x_214 5)) (mem2 x_213 x_214 x_210))) (forall ((x_215 Int)(x_216 Int) ) (=> (and (forall ((x_217 Int) ) (=> (forall ( (x_218 Int) ) (= (exists ( (x_219 Int) ) (mem2 x_218 x_219 x_210)) (and (>= x_218 1) (<= x_218 x_217)))) (= x_215 (- 5 x_217)))) (= x_216 5)) (mem2 x_215 x_216 g_s2_2))))))))
(check-sat)
(exit)
