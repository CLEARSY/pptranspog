...
(assert true)
; Global hypotheses
(assert (exists ( (x_71 (P (C Int Int))) ) (and  (forall ( (x_72 Int) (x_73 Int) ) (= (mem2 x_73 x_72 x_71) (mem2 x_73 x_72 g_s0_0))) (or  (mem2 g_ii_5 g_c0_6 x_71) (forall ((x_74 Int) ) (=> (forall ((x_75 Int) ) (=> (forall ( (x_76 Int) ) (= (exists ( (x_77 Int) ) (mem2 x_76 x_77 x_71)) (and (>= x_76 1) (<= x_76 x_75)))) (= x_74 (- g_ii_5 x_75)))) (mem2 x_74 g_c0_6 g_s1_1)))))))
; Local hypotheses
; Goal
(assert (not (exists ( (x_78 (P (C Int Int))) ) (and  (forall ( (x_79 Int) (x_80 Int) ) (= (mem2 x_80 x_79 x_78) (mem2 x_80 x_79 g_empty_seq_4))) (or  (mem2 g_ii_5 g_c0_6 x_78) (forall ((x_81 Int) ) (=> (forall ((x_82 Int) ) (=> (forall ( (x_83 Int) ) (= (exists ( (x_84 Int) ) (mem2 x_83 x_84 x_78)) (and (>= x_83 1) (<= x_83 x_82)))) (= x_81 (- g_ii_5 x_82)))) (mem2 x_81 g_c0_6 g_s0_0))))))))
(check-sat)
(exit)
