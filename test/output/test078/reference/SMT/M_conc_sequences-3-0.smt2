...
(assert true)
; Global hypotheses
(assert (exists ( (x_106 (P (C Int Int))) ) (and  (forall ( (x_107 Int) (x_108 Int) ) (= (mem2 x_108 x_107 x_106) (mem2 x_108 x_107 g_s0_0))) (or  (mem2 g_ii_5 g_c0_6 x_106) (forall ((x_109 Int) ) (=> (forall ((x_110 Int) ) (=> (forall ( (x_111 Int) ) (= (exists ( (x_112 Int) ) (mem2 x_111 x_112 x_106)) (and (>= x_111 1) (<= x_111 x_110)))) (= x_109 (- g_ii_5 x_110)))) (mem2 x_109 g_c0_6 g_s1_1)))))))
(assert (exists ( (x_113 (P (C Int Int))) ) (and  (forall ( (x_114 Int) (x_115 Int) ) (= (mem2 x_115 x_114 x_113) (mem2 x_115 x_114 g_empty_seq_4))) (or  (mem2 g_ii_5 g_c0_6 x_113) (forall ((x_116 Int) ) (=> (forall ((x_117 Int) ) (=> (forall ( (x_118 Int) ) (= (exists ( (x_119 Int) ) (mem2 x_118 x_119 x_113)) (and (>= x_118 1) (<= x_118 x_117)))) (= x_116 (- g_ii_5 x_117)))) (mem2 x_116 g_c0_6 g_s0_0)))))))
(assert (exists ( (x_120 (P (C Int Int))) ) (and  (forall ( (x_121 Int) (x_122 Int) ) (= (mem2 x_122 x_121 x_120) (mem2 x_122 x_121 g_s0_0))) (or  (mem2 g_ii_5 g_c0_6 x_120) (forall ((x_123 Int) ) (=> (forall ((x_124 Int) ) (=> (forall ( (x_125 Int) ) (= (exists ( (x_126 Int) ) (mem2 x_125 x_126 x_120)) (and (>= x_125 1) (<= x_125 x_124)))) (= x_123 (- g_ii_5 x_124)))) (mem2 x_123 g_c0_6 g_empty_seq_4)))))))
; Local hypotheses
; Goal
(assert (not (exists ( (x_127 (P (C Int Int))) ) (and  (forall ( (x_128 Int) (x_129 Int) ) (= (mem2 x_129 x_128 x_127) (mem2 x_129 x_128 g_empty_seq_4))) (or  (mem2 g_ii_5 g_c0_6 x_127) (forall ((x_130 Int) ) (=> (forall ((x_131 Int) ) (=> (forall ( (x_132 Int) ) (= (exists ( (x_133 Int) ) (mem2 x_132 x_133 x_127)) (and (>= x_132 1) (<= x_132 x_131)))) (= x_130 (- g_ii_5 x_131)))) (mem2 x_130 g_c0_6 g_empty_seq_4))))))))
(check-sat)
(exit)
