...
(assert true)
; Global hypotheses
(assert (exists ( (x_20 Int) ) (and  (forall ((x_21 Int) ) (=> (= x_21 10) (mem2 x_21 x_20 g_ss_3))) (forall ((x_22 Int) ) (=> (= x_22 5) (mem2 x_20 x_22 g_tt_4))))))
; Local hypotheses
; Goal
(assert (not (exists ( (x_23 Int) ) (and  (mem2 g_c0_6 x_23 g_rr_2) (mem3 x_23 g_c1_7 g_uu_5)))))
(check-sat)
(exit)
