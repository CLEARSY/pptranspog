...
(assert (forall ( (x_12 Int) ) (= (exists ( (x_13 Int) ) (and  (= x_13 g_c1_1) (= x_12 (+ x_13 1)))) (mem0 x_12 g_s1_0))))
(assert (forall ( (x_14 Int) ) (= (exists ( (x_15 Int) ) (and  (mem0 x_15 g_s1_0) (= x_14 (+ x_15 1)))) (mem0 x_14 g_s1_0))))
; Local hypotheses
; Goal
(assert (not (= 1 (- 1 1))))
(check-sat)
