...
(assert (forall ( (x_16 Int) ) (= (exists ( (x_17 Int) ) (and  (= x_17 g_c1_1) (= x_16 (+ x_17 1)))) (mem0 x_16 g_s1_0))))
(assert (forall ( (x_18 Int) ) (= (exists ( (x_19 Int) ) (and  (mem0 x_19 g_s1_0) (= x_18 (+ x_19 1)))) (mem0 x_18 g_s1_0))))
(assert (= 1 (- 1 1)))
; Local hypotheses
; Goal
