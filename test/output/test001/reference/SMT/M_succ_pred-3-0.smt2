...
(assert (forall ( (x_8 Int) ) (= (exists ( (x_9 Int) ) (and  (= x_9 g_c1_1) (= x_8 (+ x_9 1)))) (mem0 x_8 g_s1_0))))
; Local hypotheses
; Goal
(assert (not (forall ( (x_10 Int) ) (= (exists ( (x_11 Int) ) (and  (mem0 x_11 g_s1_0) (= x_10 (+ x_11 1)))) (mem0 x_10 g_s1_0)))))
(check-sat)
(exit)
