...
(assert true)
; Global hypotheses
(assert (exists ( (x_21 Int) ) (and  (and (>= x_21 g_c0_4) (<= x_21 g_c1_5)) (mem2 x_21 g_c0_4 g_rr_2))))
(assert (exists ( (x_22 Int) ) (and  false (forall ((x_23 (P Int)) ) (=> (forall ( (x_24 Int) ) (= (mem0 x_24 x_23) (= x_24 g_c0_4))) (mem3 x_22 x_23 g_tt_3))))))
; Local hypotheses
; Goal
(assert (not (exists ( (x_25 Int) ) (and  (or  (= x_25 7) (= x_25 10) (= x_25 2)) (or  (and (= x_25 2) (= 7 7)) (and (= x_25 5) (= 7 9)) (and (= x_25 2) (= 7 6)) (and (= x_25 7) (= 7 9)) (and (= x_25 5) (= 7 3)))))))
(check-sat)
(exit)
