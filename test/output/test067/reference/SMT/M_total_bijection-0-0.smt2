...
; Local hypotheses
; Goal
(assert (not (and (and (exists ( (x_19 (P (C Int Int))) ) (and (forall ( (x_20 Int) (x_21 Int) ) (= (mem2 x_21 x_20 x_19) (mem2 x_21 x_20 g_rel1_0))) (forall ( (x_22 Int) (x_23 Int) (x_24 Int) ) (=> (and  (mem2 x_22 x_23 x_19) (mem2 x_22 x_24 x_19)) (= x_23 x_24))) (forall ( (x_25 Int) ) (= (and (>= x_25 0) (<= x_25 7)) (exists ( (x_26 Int) ) (mem2 x_25 x_26 x_19)))) (forall ( (x_27 Int) ) (=> (exists ( (x_28 Int) ) (mem2 x_28 x_27 x_19)) (and (>= x_27 0) (<= x_27 10)))))) (forall ( (x_29 Int) ) (=> (and (>= x_29 0) (<= x_29 10)) (exists ( (x_30 Int) ) (mem2 x_30 x_29 g_rel1_0))))) (forall ( (x_31 Int) (x_32 Int) (x_33 Int) ) (=> (and  (mem2 x_32 x_31 g_rel1_0) (mem2 x_33 x_31 g_rel1_0)) (= x_32 x_33))))))
(check-sat)
(exit)
