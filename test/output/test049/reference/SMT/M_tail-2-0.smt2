...
(assert true)
; Global hypotheses
(assert (forall ((x_31 Int)(x_32 Int) ) (=> (and (= x_31 (+ 2 1)) (= x_32 18)) (mem2 x_31 x_32 g_ss_0))))
(assert (and (= (+ 1 1) 1) (= 1 2)))
; Local hypotheses
; Goal
(assert (not (forall ((x_33 Int) ) (=> (= x_33 (+ g_ii_2 1)) (mem3 x_33 g_c0_3 g_tt_1)))))
(check-sat)
(exit)
