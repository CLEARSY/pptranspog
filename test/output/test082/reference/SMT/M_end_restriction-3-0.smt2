...
(assert true)
; Global hypotheses
(assert (forall ((x_47 Int) ) (=> (= x_47 (+ g_ii_3 g_c1_5)) (mem2 x_47 g_c0_4 g_s0_0))))
(assert (forall ((x_48 Int) ) (=> (= x_48 (+ g_ii_3 g_c1_5)) (mem2 x_48 g_c0_4 g_empty_seq_2))))
(assert (forall ((x_49 Int)(x_50 Int) ) (=> (and (= x_49 (+ 4 3)) (= x_50 1)) (mem2 x_49 x_50 g_s1_1))))
; Local hypotheses
; Goal
(assert (not (forall ((x_51 Int)(x_52 Int) ) (=> (and (= x_51 (+ 6 3)) (= x_52 3)) (mem2 x_51 x_52 g_s1_1)))))
(check-sat)
(exit)
