...
(assert true)
; Global hypotheses
(assert (forall ((x_43 Int) ) (=> (= x_43 (+ g_ii_3 g_c1_5)) (mem2 x_43 g_c0_4 g_s0_0))))
(assert (forall ((x_44 Int) ) (=> (= x_44 (+ g_ii_3 g_c1_5)) (mem2 x_44 g_c0_4 g_empty_seq_2))))
; Local hypotheses
; Goal
(assert (not (forall ((x_45 Int)(x_46 Int) ) (=> (and (= x_45 (+ 4 3)) (= x_46 1)) (mem2 x_45 x_46 g_s1_1)))))
(check-sat)
(exit)
