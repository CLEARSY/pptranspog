...
; Global hypotheses
(assert (forall ((x_61 (P Int)) ) (=> (forall ( (x_62 Int) ) (= (mem0 x_62 x_61) (exists ( (x_63 Int) ) (and  (mem0 x_63 g_S1_0) (= x_62 x_63))))) (>= (isum x_61) 0))))
(assert (forall ((x_64 (P Int)) ) (=> (forall ( (x_65 Int) ) (= (mem0 x_65 x_64) (exists ( (x_66 Int) ) (and  (mem0 x_66 g_S2_1) (= x_65 x_66))))) (>= (isum x_64) 1))))
; Local hypotheses
; Goal
(assert (not (forall ((x_67 (P Int)) ) (=> (forall ( (x_68 Int) ) (= (mem0 x_68 x_67) (exists ( (x_69 Int) ) (and  (mem0 x_69 g_S3_2) (= x_68 x_69))))) (>= (isum x_67) 6)))))
(check-sat)
(exit)
