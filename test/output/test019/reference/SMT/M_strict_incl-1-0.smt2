...
; Global hypotheses
(assert (and (forall ( (x_27 Int) ) (=> (mem0 x_27 g_c1_2) (mem0 x_27 g_s0_0))) (not (forall ( (x_28 Int) ) (= (mem0 x_28 g_c1_2) (mem0 x_28 g_s0_0))))))
; Local hypotheses
; Goal
(assert (not (not (and (forall ( (x_29 Int) ) (=> (mem0 x_29 g_c1_2) (mem0 x_29 g_s0_0))) (not (forall ( (x_30 Int) ) (= (mem0 x_30 g_c1_2) (mem0 x_30 g_s0_0))))))))
(check-sat)
(exit)
