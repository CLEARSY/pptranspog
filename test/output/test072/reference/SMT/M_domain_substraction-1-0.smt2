...
; Global hypotheses
(assert (and  (forall ((x_14 Int)(x_15 Int) ) (=> (and (= x_14 10) (= x_15 5)) (mem2 x_14 x_15 g_ss_3))) (not (and (>= 10 8) (<= 10 10)))))
; Local hypotheses
; Goal
(assert (not (and  (mem2 g_c0_5 g_c1_6 g_rr_2) (not (mem0 g_c0_5 g_s2_4)))))
(check-sat)
(exit)
