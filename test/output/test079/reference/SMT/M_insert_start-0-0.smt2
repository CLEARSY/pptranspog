...
; Local hypotheses
; Goal
(assert (not (exists ( (x_40 (P (C Int Int))) ) (and  (forall ( (x_41 Int) (x_42 Int) ) (= (mem2 x_42 x_41 x_40) (and (= x_42 1) (= x_41 g_c1_4)))) (or  (mem2 g_ii_3 g_c0_5 x_40) (forall ((x_43 Int) ) (=> (forall ((x_44 Int) ) (=> (forall ( (x_45 Int) ) (= (exists ( (x_46 Int) ) (mem2 x_45 x_46 x_40)) (and (>= x_45 1) (<= x_45 x_44)))) (= x_43 (- g_ii_3 x_44)))) (mem2 x_43 g_c0_5 g_s0_0))))))))
(check-sat)
(exit)
