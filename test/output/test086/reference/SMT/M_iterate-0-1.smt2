...
; Local hypotheses
; Goal
(assert (not (forall ((x_14 (P (C Int Int))) ) (=> (forall ( (x_15 Int) (x_16 Int) ) (= (mem2 x_16 x_15 x_14) (or  (and (= x_16 2) (= x_15 6)) (and (= x_16 5) (= x_15 9)) (and (= x_16 7) (= x_15 9)) (and (= x_16 5) (= x_15 3))))) (mem_it0 g_c0_5 g_c1_6 x_14 g_ii_4)))))
(check-sat)
(exit)
