...
; Local hypotheses
; Goal
(assert (not (forall ((x_20 (P (C Int Int))) ) (=> (forall ( (x_21 Int) (x_22 Int) ) (= (mem2 x_22 x_21 x_20) (or  (and (= x_22 2) (= x_21 6)) (and (= x_22 5) (= x_21 9)) (and (= x_22 7) (= x_21 9)) (and (= x_22 5) (= x_21 3))))) (mem_it0 g_c0_5 g_c1_6 x_20 2)))))
(check-sat)
(exit)
