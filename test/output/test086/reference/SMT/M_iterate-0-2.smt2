...
; Local hypotheses
; Goal
(assert (not (forall ((x_17 (P (C Int Int))) ) (=> (forall ( (x_18 Int) (x_19 Int) ) (= (mem2 x_19 x_18 x_17) (or  (and (= x_19 2) (= x_18 6)) (and (= x_19 5) (= x_18 9)) (and (= x_19 7) (= x_18 9)) (and (= x_19 5) (= x_18 3))))) (mem_it0 g_c0_5 g_c1_6 x_17 0)))))
(check-sat)
(exit)
