...
(assert true)
; Global hypotheses
(assert (and (exists ( (x_26 (P Int)) ) (mem2 g_c0_4 x_26 g_rr_2)) (forall ((x_27 (P Int)) ) (=> (mem2 g_c0_4 x_27 g_rr_2) (mem0 g_c1_5 x_27)))))
(assert (and (exists ( (x_28 (P Int)) ) (forall ((x_29 Int) ) (=> (= x_29 5) (mem2 x_29 x_28 g_tt_3)))) (forall ((x_30 (P Int))(x_31 Int) ) (=> (and (forall ((x_32 Int) ) (=> (= x_32 5) (mem2 x_32 x_30 g_tt_3))) (= x_31 9)) (mem0 x_31 x_30)))))
; Local hypotheses
; Goal
(assert (not (and (exists ( (x_33 (P Int)) ) (forall ((x_34 Int) ) (=> (= x_34 2) (mem2 x_34 x_33 g_tt_3)))) (forall ((x_35 (P Int))(x_36 Int) ) (=> (and (forall ((x_37 Int) ) (=> (= x_37 2) (mem2 x_37 x_35 g_tt_3))) (= x_36 6)) (mem0 x_36 x_35))))))
(check-sat)
(exit)
