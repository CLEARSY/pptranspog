...
; Global hypotheses
(assert (and (and (forall ( (x_43 Int) (x_44 Int) ) (=> (mem2 x_44 x_43 g_rel1_0) (and (and (>= x_44 0) (<= x_44 7)) (and (>= x_43 0) (<= x_43 10))))) (forall ( (x_45 Int) (x_46 Int) (x_47 Int) ) (=> (and  (mem2 x_45 x_46 g_rel1_0) (mem2 x_45 x_47 g_rel1_0)) (= x_46 x_47)))) (forall ( (x_48 Int) ) (=> (and (>= x_48 0) (<= x_48 10)) (exists ( (x_49 Int) ) (mem2 x_49 x_48 g_rel1_0))))))
(assert (and (and (forall ( (x_50 Int) (x_51 Int) ) (=> (mem2 x_51 x_50 g_fun1_1) (and (exists ( (x_52 Int) ) (mem2 x_51 x_52 g_fun1_1)) (exists ( (x_53 Int) ) (mem2 x_53 x_50 g_fun1_1))))) (forall ( (x_54 Int) (x_55 Int) (x_56 Int) ) (=> (and  (mem2 x_54 x_55 g_fun1_1) (mem2 x_54 x_56 g_fun1_1)) (= x_55 x_56)))) (forall ( (x_57 Int) ) (=> (exists ( (x_58 Int) ) (mem2 x_58 x_57 g_fun1_1)) (exists ( (x_59 Int) ) (mem2 x_59 x_57 g_fun1_1))))))
; Local hypotheses
; Goal
(assert (not (and (and (forall ( (x_60 Int) (x_61 Int) ) (=> (mem2 x_61 x_60 g_fun2_2) (and true true))) (forall ( (x_62 Int) (x_63 Int) (x_64 Int) ) (=> (and  (mem2 x_62 x_63 g_fun2_2) (mem2 x_62 x_64 g_fun2_2)) (= x_63 x_64)))) (forall ( (x_65 Int) ) (=> true (exists ( (x_66 Int) ) (mem2 x_66 x_65 g_fun2_2)))))))
(check-sat)
(exit)
