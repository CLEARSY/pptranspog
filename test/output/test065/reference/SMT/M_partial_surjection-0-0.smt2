...
; Local hypotheses
; Goal
(assert (not (and (and (forall ( (x_19 Int) (x_20 Int) ) (=> (mem2 x_20 x_19 g_rel1_0) (and (and (>= x_20 0) (<= x_20 7)) (and (>= x_19 0) (<= x_19 10))))) (forall ( (x_21 Int) (x_22 Int) (x_23 Int) ) (=> (and  (mem2 x_21 x_22 g_rel1_0) (mem2 x_21 x_23 g_rel1_0)) (= x_22 x_23)))) (forall ( (x_24 Int) ) (=> (and (>= x_24 0) (<= x_24 10)) (exists ( (x_25 Int) ) (mem2 x_25 x_24 g_rel1_0)))))))
(check-sat)
(exit)
