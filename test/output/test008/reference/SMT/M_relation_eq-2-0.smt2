...
; Global hypotheses
(assert (forall ((x_28 Int)(x_29 Int) ) (=> (and (= x_28 2) (= x_29 7)) (mem2 x_28 x_29 g_rel1_0))))
(assert (forall ((x_30 Int)(x_31 Int) ) (=> (and (= x_30 2) (= x_31 7)) (mem2 x_30 x_31 g_rel1_0))))
(assert (forall ((x_32 Int)(x_33 Int) ) (=> (and (= x_32 1) (= x_33 3)) (mem2 x_32 x_33 g_fun1_1))))
(assert (forall ((x_34 Int)(x_35 Int) ) (=> (and (= x_34 1) (= x_35 3)) (mem2 x_34 x_35 g_fun1_1))))
; Local hypotheses
; Goal
(assert (not (forall ((x_36 Int)(x_37 Int) ) (=> (and (= x_36 1) (= x_37 2)) (mem2 x_36 x_37 g_fun2_2)))))
(check-sat)
(exit)
