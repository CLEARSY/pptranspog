...
; Global hypotheses
(assert (forall ((x_38 Int)(x_39 Int) ) (=> (and (= x_38 2) (= x_39 7)) (mem2 x_38 x_39 g_rel1_0))))
(assert (forall ((x_40 Int)(x_41 Int) ) (=> (and (= x_40 2) (= x_41 7)) (mem2 x_40 x_41 g_rel1_0))))
(assert (forall ((x_42 Int)(x_43 Int) ) (=> (and (= x_42 1) (= x_43 3)) (mem2 x_42 x_43 g_fun1_1))))
(assert (forall ((x_44 Int)(x_45 Int) ) (=> (and (= x_44 1) (= x_45 3)) (mem2 x_44 x_45 g_fun1_1))))
(assert (forall ((x_46 Int)(x_47 Int) ) (=> (and (= x_46 1) (= x_47 2)) (mem2 x_46 x_47 g_fun2_2))))
(assert (forall ((x_48 Int)(x_49 Int) ) (=> (and (= x_48 1) (= x_49 2)) (mem2 x_48 x_49 g_fun2_2))))
; Local hypotheses
; Goal
(assert (not (forall ((x_50 Int)(x_51 Int) ) (=> (and (= x_50 1) (= x_51 2)) (mem2 x_50 x_51 g_fun3_3)))))
(check-sat)
(exit)
