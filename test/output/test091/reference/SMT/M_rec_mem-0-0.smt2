...
; Local hypotheses
; Goal
(assert (not (forall ((x_31 (P Int))(x_32 (P Bool)) ) (=> (forall ((x_33 (P Int)) ) (=> (forall ( (x_34 Int) ) (= (mem0 x_34 x_33) (and (>= x_34 0) (<= x_34 g_ii_2)))) (mem4 x_33 x_31 x_32 g_get_res_set_1))) (mem0 g_ii_2 x_31)))))
(check-sat)
(exit)
