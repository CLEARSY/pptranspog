...
(assert true)
; Global hypotheses
(assert (forall ((x_57 (P Int))(x_58 (P Bool)) ) (=> (forall ((x_59 (P Int)) ) (=> (forall ( (x_60 Int) ) (= (mem0 x_60 x_59) (and (>= x_60 0) (<= x_60 g_ii_2)))) (mem4 x_59 x_57 x_58 g_get_res_set_1))) (mem0 g_ii_2 x_57))))
(assert (forall ((x_61 (P Int))(x_62 (P Bool)) ) (=> (forall ((x_64 (P Int)) ) (=> (forall ( (x_65 Int) ) (= (mem0 x_65 x_64) (= x_65 12))) (mem4 x_64 x_61 x_62 g_get_res_set_1))) (forall ((x_63 Int) ) (=> (= x_63 12) (mem0 x_63 x_61))))))
(assert (forall ((x_66 (P Int))(x_67 (P Bool)) ) (=> (forall ((x_68 (P Int)) ) (=> (forall ( (x_69 Int) ) (= (mem0 x_69 x_68) (and (>= x_69 0) (<= x_69 g_ii_2)))) (mem4 x_68 x_66 x_67 g_get_res_set_1))) (mem3 g_bb_3 x_67))))
; Local hypotheses
; Goal
(assert (not (forall ((x_70 (P Int))(x_71 (P Bool)) ) (=> (forall ((x_73 (P Int)) ) (=> (forall ( (x_74 Int) ) (= (mem0 x_74 x_73) (and (>= x_74 0) (<= x_74 g_ii_2)))) (mem4 x_73 x_70 x_71 g_get_res_set_1))) (forall ((x_72 Bool) ) (=> (= x_72 true) (mem3 x_72 x_71)))))))
(check-sat)
(exit)
