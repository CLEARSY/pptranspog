...
; Local hypotheses
; Goal
(assert (not (exists ( (x_40 (P (C Int Int))) ) (and  (forall ( (x_41 Int) (x_42 Int) ) (= (mem2 x_42 x_41 x_40) (mem2 x_42 x_41 g_s0_0))) (or  (mem2 g_ii_3 g_c0_4 x_40) (and (forall ((x_43 Int) ) (=> (forall ( (x_44 Int) ) (= (exists ( (x_45 Int) ) (mem2 x_44 x_45 x_40)) (and (>= x_44 1) (<= x_44 x_43)))) (= (- g_ii_3 x_43) 1))) (= g_c0_4 g_c1_5)))))))
(check-sat)
(exit)
