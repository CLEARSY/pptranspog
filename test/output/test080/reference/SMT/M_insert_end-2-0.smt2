...
(assert true)
; Global hypotheses
(assert (exists ( (x_58 (P (C Int Int))) ) (and  (forall ( (x_59 Int) (x_60 Int) ) (= (mem2 x_60 x_59 x_58) (mem2 x_60 x_59 g_s0_0))) (or  (mem2 g_ii_3 g_c0_4 x_58) (and (forall ((x_61 Int) ) (=> (forall ( (x_62 Int) ) (= (exists ( (x_63 Int) ) (mem2 x_62 x_63 x_58)) (and (>= x_62 1) (<= x_62 x_61)))) (= (- g_ii_3 x_61) 1))) (= g_c0_4 g_c1_5))))))
(assert (exists ( (x_64 (P (C Int Int))) ) (and  (forall ( (x_65 Int) (x_66 Int) ) (= (mem2 x_66 x_65 x_64) (mem2 x_66 x_65 g_empty_seq_2))) (or  (mem2 g_ii_3 g_c0_4 x_64) (and (forall ((x_67 Int) ) (=> (forall ( (x_68 Int) ) (= (exists ( (x_69 Int) ) (mem2 x_68 x_69 x_64)) (and (>= x_68 1) (<= x_68 x_67)))) (= (- g_ii_3 x_67) 1))) (= g_c0_4 g_c1_5))))))
; Local hypotheses
; Goal
(assert (not (exists ( (x_70 (P (C Int Int))) ) (and  (forall ( (x_71 Int) (x_72 Int) ) (= (mem2 x_72 x_71 x_70) (mem2 x_72 x_71 g_s1_1))) (or  (forall ((x_73 Int)(x_74 Int) ) (=> (and (= x_73 1) (= x_74 5)) (mem2 x_73 x_74 x_70))) (and (forall ((x_75 Int) ) (=> (forall ( (x_76 Int) ) (= (exists ( (x_77 Int) ) (mem2 x_76 x_77 x_70)) (and (>= x_76 1) (<= x_76 x_75)))) (= (- 1 x_75) 1))) (= 5 9)))))))
(check-sat)
(exit)
