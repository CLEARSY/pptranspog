...
(assert true)
; Global hypotheses
(assert (exists ( (x_46 (P (C Int Int))) ) (and  (forall ( (x_47 Int) (x_48 Int) ) (= (mem2 x_48 x_47 x_46) (mem2 x_48 x_47 g_s0_0))) (or  (mem2 g_ii_3 g_c0_4 x_46) (and (forall ((x_49 Int) ) (=> (forall ( (x_50 Int) ) (= (exists ( (x_51 Int) ) (mem2 x_50 x_51 x_46)) (and (>= x_50 1) (<= x_50 x_49)))) (= (- g_ii_3 x_49) 1))) (= g_c0_4 g_c1_5))))))
; Local hypotheses
; Goal
(assert (not (exists ( (x_52 (P (C Int Int))) ) (and  (forall ( (x_53 Int) (x_54 Int) ) (= (mem2 x_54 x_53 x_52) (mem2 x_54 x_53 g_empty_seq_2))) (or  (mem2 g_ii_3 g_c0_4 x_52) (and (forall ((x_55 Int) ) (=> (forall ( (x_56 Int) ) (= (exists ( (x_57 Int) ) (mem2 x_56 x_57 x_52)) (and (>= x_56 1) (<= x_56 x_55)))) (= (- g_ii_3 x_55) 1))) (= g_c0_4 g_c1_5)))))))
(check-sat)
(exit)
