...
(assert true)
; Global hypotheses
(assert (= (mem2 g_c0_5 g_c1_6 g_rr_2) (mem2 g_c0_5 g_c1_6 g_rr_2)))
(assert (forall ((x_17 Int)(x_18 Int) ) (=> (and (= x_17 2) (= x_18 13)) (mem2 x_17 x_18 g_ss_3))))
; Local hypotheses
; Goal
(assert (not (forall ((x_19 Int)(x_20 Int) ) (=> (and (= x_19 2) (= x_20 7)) (mem2 x_19 x_20 g_tt_4)))))
(check-sat)
(exit)
