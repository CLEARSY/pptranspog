...
(assert true)
; Global hypotheses
(assert (and (forall ((x_35 Int)(x_36 Int) ) (=> (and (= x_35 2) (= x_36 18)) (mem2 x_35 x_36 g_ss_0))) (not (and (forall ( (x_37 Int) ) (= (exists ( (x_38 Int) ) (mem2 x_37 x_38 g_ss_0)) (and (>= x_37 1) (<= x_37 2)))) (forall ((x_39 Int)(x_40 Int) ) (=> (and (forall ( (x_41 Int) ) (= (exists ( (x_42 Int) ) (mem2 x_41 x_42 g_ss_0)) (and (>= x_41 1) (<= x_41 x_39)))) (= x_40 18)) (mem2 x_39 x_40 g_ss_0)))))))
; Local hypotheses
; Goal
(assert (not (and (and (= 1 1) (= 1 2)) (not (and (forall ( (x_43 Int) ) (= (exists ( (x_44 Int) ) (and (= x_43 1) (= x_44 2))) (and (>= x_43 1) (<= x_43 1)))) (and (forall ( (x_45 Int) ) (= (exists ( (x_46 Int) ) (and (= x_45 1) (= x_46 2))) (and (>= x_45 1) (<= x_45 1)))) (= 1 2)))))))
(check-sat)
(exit)
