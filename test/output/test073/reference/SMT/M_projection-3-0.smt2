...
(assert true)
; Global hypotheses
(assert (and  (= 10 5) (forall ((x_13 Int) ) (=> (= x_13 10) (mem0 x_13 g_ss_3))) (and (>= 5 0) (<= 5 5))))
(assert (and  (= g_c0_4 g_c2_5) (mem0 g_c0_4 g_s0_0) (mem0 g_c1_6 g_s1_1)))
(assert (and  (= 5 10) (forall ((x_14 Int) ) (=> (= x_14 10) (mem0 x_14 g_ss_3))) (and (>= 5 0) (<= 5 5))))
; Local hypotheses
; Goal
(assert (not (and  (= g_c1_6 g_c2_5) (mem0 g_c0_4 g_s0_0) (mem0 g_c1_6 g_s1_1))))
(check-sat)
(exit)
