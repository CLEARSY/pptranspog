            ...
            case Expr::EKind::BinaryExpr: {
                ...
                switch (b.op) {
                    ...
                    case Expr::BinaryOp::IExponentiation:
                        translateBinOp(str, "iexp", ctx, eqs, b, used_ids);
                        return;
...
//        assert(e.getTag() != Expr::EKind::Id);
    ...
    const string tff_min_int_axiom =
        "tff(min_int_axiom,axiom,(min_int = $uminus(" + minint + "))).\n";
    const string tff_max_int_axiom =
        "tff(max_int_axiom,axiom,(max_int = " + maxint + ")).\n";
    const string prelude_int =
        R"(
tff(min_int_type,type,(min_int: $int)).
tff(max_int_type,type,(max_int: $int)).
)" + tff_min_int_axiom + tff_max_int_axiom;
    ...
    out << "%------------------------------------------------------------------"
        ...
        << "% English  : " << endl
        << "% Comments : Generated by PPTRANS-TPTP" << endl
        << "% Source   : " << endl
        << "%------------------------------------------------------------------"
           "--------"
        << endl;
